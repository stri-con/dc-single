...
kable(text_tbl, escape = FALSE, caption = "CONSERVATIVE 8-COLOR PALETTE") %>%
...
kable(text_tbl, escape = FALSE, caption = "12-COLOR PALETTE") %>%
  kable_styling(bootstrap_options = c("bordered", "condensed"), 
...
kable(text_tbl, escape = FALSE, caption = "13-COLOR PALETTE") %>%
  kable_styling(bootstrap_options = c("bordered", "condensed"), 
...
kable(text_tbl, escape = FALSE, caption = "15-COLOR PALETTE") %>%
  kable_styling(bootstrap_options = c("bordered", "condensed"), 
