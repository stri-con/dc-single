...
kable(text_tbl, escape = FALSE, caption = "[CONSERVATIVE 8-COLOR PALETTE](files/8-color-pal.txt)") %>%
...
kable(text_tbl, escape = FALSE, caption = "[12-COLOR PALETTE](files/12-color-pal.txt)") %>%
  kable_styling(bootstrap_options = c("bordered", "condensed"), 
...
kable(text_tbl, escape = FALSE, caption = "[13-COLOR PALETTE](files/13-color-pal.txt)") %>%
  kable_styling(bootstrap_options = c("bordered", "condensed"), 
...
kable(text_tbl, escape = FALSE, caption = "[15-COLOR PALETTE](files/15-color-pal.txt)") %>%
  kable_styling(bootstrap_options = c("bordered", "condensed"), 
